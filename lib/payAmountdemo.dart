...
class PayAmountDemo extends StatefulWidget {
  const PayAmountDemo({Key? key}) : super(key: key);

  @override
  State<PayAmountDemo> createState() => _PayAmountDemoState();
}

class _PayAmountDemoState extends State<PayAmountDemo> {
  Razorpay? razorpay;
